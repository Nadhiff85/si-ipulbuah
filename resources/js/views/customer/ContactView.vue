  ...
  <div class="max-w-3xl mx-auto px-4 py-12">
    ...
    <div class="grid sm:grid-cols-2 gap-5">
      <div class="bg-white rounded-xl2 border border-ink/5 p-5">
        <p class="font-semibold text-ink mb-2">📍 Alamat Toko</p>
        <p class="text-ink/70 text-sm mb-3">{{ storeInfo.address }}</p>
        <a :href="storeInfo.googleMapsLink" target="_blank" class="text-primary text-sm font-medium hover:underline">Lihat di Google Maps →</a>
      </div>
      <div class="bg-white rounded-xl2 border border-ink/5 p-5">
