<template>
  <div class="max-w-6xl mx-auto px-4 py-8">
    <h1 class="text-xl font-bold text-ink mb-1">🏷️ Promo Spesial</h1>
    ...
    <div v-else class="grid grid-cols-2 sm:grid-cols-4 gap-4">
      <router-link
        ...
        :key="p.id"
        :to="`/produk/${p.slug}`"
        class="bg-white rounded-xl2 border border-ink/5 overflow-hidden hover:shadow-md transition relative"
      >
